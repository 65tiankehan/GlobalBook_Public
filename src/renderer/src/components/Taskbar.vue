...
const OnClickSearch = () => {
  ...
  setSearchContent(source.value + 'modules/article/search.php?searchkey=' + searchInputValue.value + '${' + `${timestamp}`)
  setPageStatus([{ name: 'search' }])
}
                      ...
                      <div class="accountPmc_Card_P accountPmc_Card_P_Hideout setup_button_height"
                        ...
                        <div style="display: flex; align-items: flex-start; justify-content: space-between">
                          <n-button text style="font-size: 24px">
                            ...
                            <p style="color: #c4c4c4;font-size: 12px;">舞动青春</p>
                          </n-button>
